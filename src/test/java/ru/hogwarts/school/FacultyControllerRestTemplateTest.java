...
public class FacultyControllerRestTemplateTest {
    ...
    void testDeleteFaculty() throws Exception {
        ...
        this.restTemplate.delete("http://localhost:" + port + "/faculty/faculty/{id}", faculty.getId());

        ResponseEntity<Faculty> response = this.restTemplate.getForEntity("http://localhost:" + port + "/faculty/faculty/{id}", Faculty.class, faculty.getId());
    ...
    void testGetStudentsByFacultyId() throws Exception {
        ...
        // Проверяем, что ответ не null и содержит студентов
